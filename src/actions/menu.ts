...
interface Separator {}
export type TabsMenu = (MenuItem[] | Separator)[]

enum MenuItem {
  UndoRmTab, Mute, Reload, Bookmark,
  MoveToNewWin, MoveToWin, MoveToPanel,
  ReopenInNewWin, ReopenInWin, ReopenInContainer,
  Pin, Duplicate, Discard, CopyUrls, Group, Flatten, ClearCookies, Close
}
